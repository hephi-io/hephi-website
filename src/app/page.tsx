...
import ChevronBack from "./assets/svgs/chevron-back.svg"
import ChevronForward from "./assets/svgs/chevron-forward.svg"
    ...
    <main>
      ...
      <section>
        <section className="h-[864px] border border-[#EBEBED] p-4 bg-[#F3F3F3] flex flex-col justify-between">
          <section>
            <nav className="fixed z-10 top-4 right-4 left-4 nav w-[92%] h-[54px] flex justify-between items-center p-2 pl-4">
          ...
          <section>
            <span className="font-normal text-[40px] leading-[48px] text-[#363636]">
              Pioneering the Future of Digital Excellence with Unmatched
      ...
      <section className="pb-4 pt-12 bg-[#F3F3F3] mb-24">
        ...
        <div className="relative w-[90%] mx-auto">
          <Image src={PictureTwo} alt="" className="w-full h-[563px]" />
          ...
          <div className="absolute top-0 left-0 w-20 h-20 rounded-xl bg-[#4795FF] border-[0.32px] border-[#EBEBED] flex justify-center items-center">
            <Image src={HephiH} alt="" width={33.03} height={31.12} />
          </div>
        </div>
      </section>
              ...
              <div className="w-[90%] h-[252px] mx-auto flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="font-normal text-base leading-4 text-[#363636] mt-6">
                    We dive deep into understanding your business, goals, and
            ...
            <div className="relative rounded-3xl bg-[#F3F3F3] py-6 mb-6">
              <div className="w-[90%] h-[252px] mx-auto flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="font-normal text-base leading-4 text-[#363636] mt-6">
                    Combining research with creative brainstorming, we develop a
                    strategic plan tailored to your vision.
                  </div>
                </div>
              </div>
            ...
            <div className="relative rounded-3xl bg-[#F3F3F3] py-6 mb-6">
              <div className="w-[90%] h-[252px] mx-auto flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="font-normal text-base leading-4 text-[#363636] mt-6">
                    Our team brings your ideas to life, crafting and refining
                    the design and building the digital solution.
                  </div>
                </div>
              </div>
            ...
            <div className="relative rounded-3xl bg-[#F3F3F3] py-6 mb-6">
              <div className="w-[90%] h-[252px] mx-auto flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="font-normal text-base leading-4 text-[#363636] mt-6">
                    We collaborate closely with you to review the work and
                    fine-tune it based on your feedback.
                  </div>
                </div>
              </div>
            ...
            <div className="relative rounded-3xl bg-[#F3F3F3] py-6 mb-6">
              <div className="w-[90%] h-[252px] mx-auto flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="font-normal text-base leading-4 text-[#363636] mt-6">
                    We launch the final product, ensuring it’s optimized for
            ...
            <div className="relative rounded-3xl bg-[#F3F3F3] py-6 mb-6">
              <div className="w-[90%] h-[252px] mx-auto flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="font-normal text-base leading-4 text-[#363636] mt-6">
                    After launch, we continue to support and enhance your
                    product to keep it aligned with your evolving needs.
                  </div>
                </div>
              </div>
      ...
      <section className="mb-24">
        ...
        <section>
          <div className="w-[90%] mx-auto">
            ...
            <div className="font-normal text-xl leading-6 text-[#2B2B2B]">
              Testimonial
            </div>

            <div className="font-normal text-[32px] leading-8 text-[#363636] mt-10">
      ...
      <section className="mb-24">
        <div className="w-[90%] mx-auto">
          ...
          <div className="mt-10 font-normal text-[32px] leading-8	text-[#363636]">
            Got Questions? We’ve Got Answers.
          </div>

          <div className="mt-10">
            <div className="rounded-3xl py-6 bg-[#4795FF]">
              <div className="w-[91.14%] mx-auto">

                <div className="flex items-start">

                  <div className="flex gap-x-4 items-start">

                    <div className="w-9 h-9 rounded-full border border-white text-white flex justify-center items-center shrink-0">
                      1
                    </div>

                    <div className="font-normal text-2xl leading-6 text-white">
                      Do you offer post-launch support?
                    </div>

                  </div>

                  <div className="w-[40.9px] h-[40.9px] rounded-full bg-white flex justify-center items-center shrink-0">
                    <Image 
                      src={Add}
                      width={23.37}
                      height={23.37}
                ...
                <div className="mt-4 flex justify-between">
                  ...
                  <div className="opacity-80 font-normal text-base leading-[19.2px] text-white">
                    Yes, we provide ongoing support and optimization services to ensure your digital product continues to perform at its best.
                  </div>

                  <div className="w-[40.9px] shrink-0"></div>
              ...
              <div className="w-[91.14%] mx-auto">
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex gap-x-4 items-start">
                    ...
                    <div className="w-9 h-9 rounded-full border border-[#A3A3A3] text-[#A3A3A3] flex justify-center items-center shrink-0">
                      2
                    </div>
                  ...
                  <div className="w-[40.9px] h-[40.9px] rounded-full border-[0.74px] border-[#A3A3A3] bg-white flex justify-center items-center shrink-0">
                    <Image 
                      src={Remove}
                      width={23.37}
                      height={23.37}
                ...
                <div className="hidden mt-4 justify-between">
              ...
              <div className="w-[91.14%] mx-auto">
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex gap-x-4 items-start">
                    ...
                    <div className="font-normal text-2xl leading-6 text-[#363636]">
                      Can you scale your services as our company grows?
                    </div>
