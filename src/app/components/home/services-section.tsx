      ...
      <div className="w-[90%] mx-auto sm:w-[94.24%] md:w-[96.66%]">
        ...
        <div className="flex flex-col gap-y-4 md:grid md:grid-cols-2 md:gap-4">
          { serviceCards.map((serviceCard, index) => (
            <div key={ index } className="rounded-3xl bg-[#F3F3F3] pt-4 pb-6 sm:rounded-[32px] sm:pt-6 sm:pb-12 md:p-0 md:bg-white">
              <div className="w-[90%] mx-auto sm:w-[93.89%] md:w-full">

                <div className={ `relative h-[294px] rounded-xl border border-[#EBEBED] sm:h-[593px] sm:rounded-3xl ${(serviceCard.isHover) ? "md:h-[577px]" : "md:h-[641px]"} mb-9 md:mb-6` }>
                  ...
                  <div className={ `absolute top-4 right-4 w-[42px] h-[42px] rounded-full flex justify-center items-center bg-[#151313] sm:top-6 sm:right-6 ${(!serviceCard.isHover && "md:hidden")}` }>
