...
import Rocket from "@/app/assets/pngs/rocket.png";
import Handshake from "@/app/assets/pngs/handshake.png";
      ...
      <div className="w-[90%] mx-auto sm:w-[94.24%] lg:max-w-[1391px]">
        ...
        <div className="flex flex-col gap-y-6 sm:grid sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
          {processSectionCards.map((processSectionCard, index) => (
            <div key={index} className="relative rounded-3xl bg-[#F3F3F3] dark:bg-[#1B1B1C] dark:border dark:border-[#313131] py-9">
