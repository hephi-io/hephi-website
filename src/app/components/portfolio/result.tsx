    ...
    <Wrapper>
      <Container className="lg:flex lg:justify-between lg:items-start">
        ...
        <div className="lg:w-[56.22%]">
          <Heading className="text-[32px] leading-8 tracking-normal text-[#363636] dark:text-white mt-10 lg:mt-0">
            {headingText}
          </Heading>
          <Paragraph className="mt-4 dark:text-[#D1D1D2]">{paragraph}</Paragraph>
        </div>
      </Container>
    </Wrapper>
  );
