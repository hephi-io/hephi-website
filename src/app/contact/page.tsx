    ...
    <div className="">
        ...
        <div className="container mx-auto w-full flex flex-col lg:flex-row justify-between items-center   p-6 gap-6  bg-[#f3f3f3] rounded-2xl lg:rounded-none md:shadow-md lg:shadow-none lg:bg-white ">
          ...
          <div className="lg:w-[50%]   w-full  lg:rounded-2xl lg:shadow-md border-none bg-[#f3f3f3]">
            <div className="flex flex-col-reverse lg:flex-col w-full lg:rounded-2xl lg:shadow-lg p-4">
              <h1 className="hidden lg:block uppercase text-black font-bold mb-10">
                Contact
              </h1>
              <div className="my-4">
                <Image
              ...
              <div className="py-5">
                <h2 className="text-4xl font-semibold mb-4 leading-[3rem]">
            ...
            <div className="w-full">
              ...
              <div className="bg-white rounded-2xl shadow-md py-2 px-4 container mx-auto  w-[100%]">
                ...
                <p className="text-gray-600 mb-6">
                  For urgent inquiries or immediate support, click below to get
                  in touch with our team. We&apos;re ready to assist you with
                  any digital needs.
                </p>
                ...
                <form className="">
                  <div className="grid md:grid-cols-2 grid-cols-1 gap-4 mb-4">
                    <input
                      type="text"
                      name="firstName"
                      className="w-full border border-gray-300 rounded-md p-3 bg-[#f3f3f3] placeholder:font-semibold"
                  ...
                  <input
                    type="email"
                    name="email"
                    className="w-full border border-gray-300 rounded-md p-3 bg-[#f3f3f3] placeholder:font-semibold mb-4"
                    required
                  ...
                  <textarea
                    name="message"
                    rows={4}
                    className="w-full border border-gray-300 rounded-md px-3 py-2 bg-[#f3f3f3] placeholder:font-semibold mb-2"
                  ...
                  <button
                    type="submit"
                    className="w-full flex justify-between items-center bg-[#4795FF] rounded-xl text-white font-bold p-4 my-4"
                  >
                    Contact Our Team
      ...
      <div className="my-4 container mx-auto p-4">
        <div className=" container mx-auto flex justify-between items-center p-4 md:flex lg:flex-row gap-6 my-7 md:justify-around lg:justify-between">
          <h4 className="text-base font-bold uppercase md:block md:text-xl lg:text-2xl">
            faq
          </h4>
          ...
          <div className="bg-[#4795FF] p-4 rounded-xl flex flex-row gap-6 items-center">
            ...
            <div className="text-white basis-full">
              ...
              <p className=" text-sm mb-4">
                yes, we provide ongoing support and optimization services to
                ensure your digital product continues to perform at its best.
              </p>
            </div>
        ...
        <div className="bg-[#4795FF]  rounded-xl container">
          <div className="flex justify-between gap-[10px] items-center lg:items-start flex-col lg:flex-row p-4">
            <div className="leading-[36px]  lg:basis-[421px]  p-4 md:text-48px lg:leading-[48px] ">
              <h1 className="text-4xl   text-white font-[400] md:font-semibold  lg:text-5xl ">
            ...
            <div className="bg-[#f3f3f3] px-3  md:px-7 py-4 rounded-2xl lg:basis-[500px] basis-full">
              <div className="flex flex-row md:flex-col gap-6 md:gap-0">
                <div className="">
                  <h1 className="text-2xl font-bold  my-2 leading-[3rem]">
                    Get in touch
                  </h1>
